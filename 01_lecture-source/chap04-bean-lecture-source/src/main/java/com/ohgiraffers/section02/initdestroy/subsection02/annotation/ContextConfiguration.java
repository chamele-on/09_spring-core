...
public class ContextConfiguration {
    ...
    * */
    ...
    public com.ohgiraffers.section02.initdestory.subsection02.annotation.Owner owner() {

        return new com.ohgiraffers.section02.initdestory.subsection02.annotation.Owner();
